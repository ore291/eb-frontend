  ...
  return (
    <div className="flex flex-col gap-16 min-h-full overflow-auto   w-full bg-bgGray overflow-aut0 wallet   mx-auto">
      <div className="mx-auto w-full bg-[#f4f4f4] ">
        <div className=" flex text-center  overflow-hidden w-12/12 mx-auto justify-center items-center mt-3 rounded-xl h-[184px] bg-gradient-to- bg-radial-at-bl from-[#363636] via-slate-800 to-[#191919]  bg-gradient-to-r shadow-lg">
